...
public class CommandSpreadPlayers extends CommandBase {
   ...
   private double func_110671_a(List p_110671_1_, World worldIn, Position[] p_110671_3_, boolean p_110671_4_) {
      ...
      for(int j = 0; j < p_110671_1_.size(); ++j) {
         ...
         entity.setPositionAndUpdate((double)((float)MathHelper.floor_double(commandspreadplayers$position.field_111101_a) + 0.5F), (double)commandspreadplayers$position.func_111092_a(worldIn), (double)MathHelper.floor_double(commandspreadplayers$position.field_111100_b) + 0.5);
