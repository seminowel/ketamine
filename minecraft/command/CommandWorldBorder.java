   ...
   public void processCommand(ICommandSender sender, String[] args) throws CommandException {
      if (args.length < 1) {
         ...
         if (args[0].equals("set")) {
            ...
            d10 = parseDouble(args[1], 1.0, 6.0E7);
            ...
            d10 = d6 + parseDouble(args[1], -d6, 6.0E7 - d6);
            ...
            d6 = worldborder.getDiameter();
            sender.setCommandStat(CommandResultStats.Type.QUERY_RESULT, MathHelper.floor_double(d6 + 0.5));
