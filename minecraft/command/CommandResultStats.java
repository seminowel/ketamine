...
public class CommandResultStats {
   ...
   public void readStatsFromNBT(NBTTagCompound tagcompound) {
      if (tagcompound.hasKey("CommandStats", 10)) {
         ...
         Type[] var3 = CommandResultStats.Type.values();
         int var4 = var3.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            Type commandresultstats$type = var3[var5];
   ...
   public void func_179671_a(CommandResultStats resultStatsIn) {
      Type[] var2 = CommandResultStats.Type.values();
      int var3 = var2.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         Type commandresultstats$type = var2[var4];
   ...
   public static enum Type {
      ...
      public static Type getTypeByName(String name) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            Type commandresultstats$type = var1[var3];
