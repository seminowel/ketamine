...
public class Block {
   ...
   public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity) {
      ...
      if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
         BlockCollisionEvent boundingBoxEvent = new BlockCollisionEvent(this, pos, axisalignedbb);
   ...
   public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
      ...
      Vec3 vec36 = vec3;
      if (vec31 != null && (vec3 == null || start.squareDistanceTo(vec31) < start.squareDistanceTo(vec3))) {
         vec36 = vec31;
      }
