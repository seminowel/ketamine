...
public class BlockSilverfish extends Block {
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List list) {
      EnumType[] var4 = BlockSilverfish.EnumType.values();
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         EnumType blocksilverfish$enumtype = var4[var6];
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      public static EnumType forModelBlock(IBlockState model) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            EnumType blocksilverfish$enumtype = var1[var3];
      ...
      static {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            EnumType blocksilverfish$enumtype = var0[var2];
