...
public class BlockLever extends Block {
   ...
   public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
      if (worldIn.isRemote) {
         ...
         worldIn.playSoundEffect((double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, "random.click", 0.3F, (Boolean)state.getValue(POWERED) ? 0.6F : 0.5F);
   ...
   public int getStrongPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
      return !(Boolean)state.getValue(POWERED) ? 0 : (((EnumOrientation)state.getValue(FACING)).getFacing() == side ? 15 : 0);
   }
   ...
   public static enum EnumOrientation implements IStringSerializable {
      ...
      static {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            EnumOrientation blocklever$enumorientation = var0[var2];
