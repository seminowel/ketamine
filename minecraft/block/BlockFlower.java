...
public abstract class BlockFlower extends BlockBush {
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List list) {
      EnumFlowerType[] var4 = BlockFlower.EnumFlowerType.getTypes(this.getBlockType());
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         EnumFlowerType blockflower$enumflowertype = var4[var6];
   ...
   public IProperty getTypeProperty() {
      if (this.type == null) {
         this.type = PropertyEnum.create("type", EnumFlowerType.class, new Predicate() {
