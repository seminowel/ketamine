...
public class BlockDoublePlant extends BlockBush implements IGrowable {
   ...
   public int damageDropped(IBlockState state) {
      return state.getValue(HALF) != BlockDoublePlant.EnumBlockHalf.UPPER && state.getValue(VARIANT) != BlockDoublePlant.EnumPlantType.GRASS ? ((EnumPlantType)state.getValue(VARIANT)).getMeta() : 0;
   }
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List list) {
      EnumPlantType[] var4 = BlockDoublePlant.EnumPlantType.values();
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         EnumPlantType blockdoubleplant$enumplanttype = var4[var6];
   ...
   public int getMetaFromState(IBlockState state) {
      return state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER ? 8 | ((EnumFacing)state.getValue(field_181084_N)).getHorizontalIndex() : ((EnumPlantType)state.getValue(VARIANT)).getMeta();
   }
   ...
   public static enum EnumPlantType implements IStringSerializable {
      ...
      static {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            EnumPlantType blockdoubleplant$enumplanttype = var0[var2];
