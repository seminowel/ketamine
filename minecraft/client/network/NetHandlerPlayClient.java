...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
      ...
      if (entity != null) {
         ...
         if (packetIn.func_149009_m() > 0) {
            ...
            ((Entity)entity).setVelocity((double)packetIn.getSpeedX() / 8000.0, (double)packetIn.getSpeedY() / 8000.0, (double)packetIn.getSpeedZ() / 8000.0);
         }
      }
   ...
   public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
      Entity entity = new EntityXPOrb(this.clientWorldController, (double)packetIn.getX() / 32.0, (double)packetIn.getY() / 32.0, (double)packetIn.getZ() / 32.0, packetIn.getXPValue());
   ...
   public void handleEntityMetadata(S1CPacketEntityMetadata packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
      Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
      List watchableObjects = packetIn.func_149376_c();
      if (entity != null && watchableObjects != null) {
         if (entity instanceof EntityPlayer) {
            EntityPlayer player = (EntityPlayer)entity;
            Iterator var5 = watchableObjects.iterator();

            while(var5.hasNext()) {
               DataWatcher.WatchableObject object = (DataWatcher.WatchableObject)var5.next();
               if (object.getDataValueId() == 6 && object.getObjectType() == 3) {
                  float health = (Float)object.getObject();
   ...
   public void handleEntityMovement(S14PacketEntity packetIn) {
      ...
      if (entity != null) {
         byte x = packetIn.func_149062_c();
         byte y = packetIn.func_149061_d();
         byte z = packetIn.func_149064_e();
         entity.serverPosX += x;
         entity.serverPosY += y;
         entity.serverPosZ += z;
         double d0 = (double)entity.serverPosX / 32.0;
         ...
         if (entity instanceof EntityOtherPlayerMP) {
            PlayerPositionUpdateEvent event = new PlayerPositionUpdateEvent((EntityPlayer)entity, new Vec3((double)x / 32.0, (double)y / 32.0, (double)z / 32.0));
   ...
   public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
      ...
      ServerSetPosLookEvent event = new ServerSetPosLookEvent(packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getYaw(), packetIn.getPitch(), packetIn.getYaw(), packetIn.getPitch());
      KetamineClient.getInstance().getEventBus().post(event);
      if (!event.isCancelled()) {
         ...
         if (((PingSpoof)KetamineClient.getInstance().getModuleManager().getModule(PingSpoof.class)).isEnabled()) {
            this.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, false));
         } else {
   ...
   public void handleEntityAttach(S1BPacketEntityAttach packetIn) {
      ...
      if (packetIn.getLeash() == 0) {
         ...
         if (packetIn.getEntityId() == this.gameController.thePlayer.getEntityId()) {
            ...
            boolean var10000;
            if (((Entity)entity).ridingEntity == null && entity1 != null) {
               var10000 = true;
            } else {
               var10000 = false;
            }
      ...
      if (entity != null) {
         ...
         while(var4.hasNext()) {
            ...
            if (iattributeinstance == null) {
               iattributeinstance = baseattributemap.registerAttribute(new RangedAttribute((IAttribute)null, s20packetentityproperties$snapshot.func_151409_a(), 0.0, Double.MIN_NORMAL, Double.MAX_VALUE));
            }
