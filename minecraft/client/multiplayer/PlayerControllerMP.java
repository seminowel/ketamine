...
public class PlayerControllerMP {
   ...
   public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
      ...
      if (this.blockHitDelay > 0) {
         ...
         if (block.getMaterial() == Material.air) {
            ...
            PlayerDamageBlockEvent onDamageBlock = new PlayerDamageBlockEvent();
   ...
   public void syncCurrentPlayItem() {
      GetClientSideCurrentSlotEvent event = new GetClientSideCurrentSlotEvent(this.mc.thePlayer.inventory.currentItem);
   ...
   public boolean onPlayerRightClick(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3 hitVec) {
      ...
      if (!this.mc.theWorld.getWorldBorder().contains(hitPos)) {
         ...
         BlockPlaceEvent event = new BlockPlaceEvent(hitPos, side, hitVec);
         KetamineClient.getInstance().getEventBus().post(event);
   ...
   public void windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
      KetamineClient.getInstance().getEventBus().post(new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));
