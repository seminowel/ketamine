...
import com.viaversion.viabackwards.utils.ProtocolHackUtil;
import io.github.nevalackin.client.api.core.ProtectedCore;
import io.github.nevalackin.client.impl.core.KetamineClient;
import io.github.nevalackin.client.impl.event.game.MiddleClickMouseEvent;
...
import io.github.nevalackin.client.impl.event.player.PlayerNameUpdateEvent;
...
public class Minecraft implements IThreadListener {
   ...
   public void run() {
      ...
      try {
         ...
         Throwable throwable = var13;

         try {
            crashreport1 = CrashReport.makeCrashReport(throwable, "Initializing game");
      ...
      } catch (ReportedException var15) {
         this.addGraphicsAndWorldToCrashReport(var15.getCrashReport());
         this.freeMemory();
         logger.fatal("Reported exception thrown!", var15);
         this.displayCrashReport(var15.getCrashReport());
      } catch (Throwable var16) {
         crashreport1 = this.addGraphicsAndWorldToCrashReport(new CrashReport("Unexpected error", var16));
         this.freeMemory();
         logger.fatal("Unreported exception thrown!", var16);
   ...
   private void startGame() throws LWJGLException, IOException {
      ...
      ProtocolHackUtil.main((String[])null);
   ...
   public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
      ...
      worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      worldrenderer.pos((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0).tex((double)((float)p_181536_3_ * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
      worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0).tex((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
      worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0).tex((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
      worldrenderer.pos((double)p_181536_1_, (double)p_181536_2_, 0.0).tex((double)((float)p_181536_3_ * f), (double)((float)p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
   ...
   private void runGameLoop() throws IOException {
      ...
      for(this.field_181543_z = k; getSystemTime() >= this.debugUpdateTime + 1000L; this.fpsCounter = 0) {
      ...
      if (this.currentScreen == null || this.currentScreen.allowUserInput) {
         while(true) {
            ...
            if (k != -1) {
               ...
               KeyBinding.setKeyBindState(k - 100, state);
               if (this.currentScreen == null) {
                  KetamineClient.getInstance().getEventBus().post(new InputEvent(InputType.MOUSE, k, state ? State.PRESSED : State.RELEASED));
               }
   ...
   private void middleClickMouse() {
      if (this.objectMouseOver != null) {
         MiddleClickMouseEvent middleClickMouseEvent = new MiddleClickMouseEvent();
         KetamineClient.getInstance().getEventBus().post(middleClickMouseEvent);
   ...
   public void setSession(Session session) {
      ...
      KetamineClient.getInstance().getEventBus().post(new PlayerNameUpdateEvent(oldName, session.getUsername()));
   }
