   ...
   protected void renderLeash(EntityLiving entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (entity != null) {
         ...
         for(k = 0; k <= 24; ++k) {
            ...
            f7 = (float)k / 24.0F;
            worldrenderer.pos(x + d13 * (double)f7 + 0.0, y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)k) / 18.0F + 0.125F), z + d15 * (double)f7).color(f4, f5, f6, 1.0F).endVertex();
            worldrenderer.pos(x + d13 * (double)f7 + 0.025, y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)k) / 18.0F + 0.125F) + 0.025, z + d15 * (double)f7).color(f4, f5, f6, 1.0F).endVertex();
         }
