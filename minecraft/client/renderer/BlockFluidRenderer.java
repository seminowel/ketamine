      ...
      if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
         ...
         if (flag) {
            ...
            if (f12 < -999.0F) {
               ...
               f40 = textureatlassprite.getInterpolatedV(0.0);
               f14 = f13;
            ...
            float f25 = f4 * f1;
            f41 = f4 * f2;
            worldRendererIn.pos(d0 + 0.0, d1 + (double)f7, d2 + 0.0).color(f24, f25, f41, 1.0F).tex((double)f13, (double)f40).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 0.0, d1 + (double)f8, d2 + 1.0).color(f24, f25, f41, 1.0F).tex((double)f14, (double)f18).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1 + (double)f9, d2 + 1.0).color(f24, f25, f41, 1.0F).tex((double)f15, (double)f19).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1 + (double)f10, d2 + 0.0).color(f24, f25, f41, 1.0F).tex((double)f39, (double)f20).lightmap(l2, i3).endVertex();
         ...
         if (flag1) {
            ...
            int i2 = l1 >> 16 & '\uffff';
            int j2 = l1 & '\uffff';
            worldRendererIn.pos(d0, d1, d2 + 1.0).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f14).lightmap(i2, j2).endVertex();
            worldRendererIn.pos(d0, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f13).lightmap(i2, j2).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f12, (double)f13).lightmap(i2, j2).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1, d2 + 1.0).color(f3, f3, f3, 1.0F).tex((double)f12, (double)f14).lightmap(i2, j2).endVertex();
            flag2 = true;
         }
         ...
         for(int i1 = 0; i1 < 4; ++i1) {
            ...
            if (aboolean[i1]) {
               ...
               flag2 = true;
               f41 = textureatlassprite1.getInterpolatedU(0.0);
               ...
               worldRendererIn.pos(d3, d1 + 0.0, d4).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d3, d1 + 0.0, d4).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d5, d1 + 0.0, d6).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d5, d1 + (double)f40, d6).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f29).lightmap(k, l).endVertex();
               worldRendererIn.pos(d3, d1 + (double)f39, d4).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f28).lightmap(k, l).endVertex();
