...
public class TextureClock extends TextureAtlasSprite {
   ...
   public void updateAnimation() {
      if (!this.framesTextureData.isEmpty()) {
         ...
         double d1;
         for(d1 = d0 - this.field_94239_h; d1 < -0.5; ++d1) {
         }
         ...
         int i;
         for(i = (int)((this.field_94239_h + 1.0) * (double)this.framesTextureData.size()) % this.framesTextureData.size(); i < 0; i = (i + this.framesTextureData.size()) % this.framesTextureData.size()) {
         }
