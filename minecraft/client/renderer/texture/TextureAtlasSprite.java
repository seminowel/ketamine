...
public class TextureAtlasSprite {
   ...
   public void updateAnimation() {
      ...
      if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
         ...
         if (i != k && k >= 0 && k < this.framesTextureData.size()) {
            TextureUtil.uploadTextureMipmap((int[][])((int[][])this.framesTextureData.get(k)), this.width, this.height, this.originX, this.originY, false, false);
         }
         ...
         for(int l = 0; l < aint.length; ++l) {
            ...
            if (l < aint1.length && aint1[l].length == aint[l].length) {
               for(int i1 = 0; i1 < aint[l].length; ++i1) {
                  ...
                  int i2 = (int)((double)((j1 & '\uff00') >> 8) * d0 + (double)((k1 & '\uff00') >> 8) * (1.0 - d0));
   ...
   public void loadSprite(BufferedImage[] images, AnimationMetadataSection meta) throws IOException {
      ...
      int j1;
      for(j1 = 0; j1 < images.length; ++j1) {
         BufferedImage bufferedimage = images[j1];
         if (bufferedimage != null) {
            if (j1 > 0 && (bufferedimage.getWidth() != i >> j1 || bufferedimage.getHeight() != j >> j1)) {
               throw new RuntimeException(String.format("Unable to load miplevel: %d, image is size: %dx%d, expected %dx%d", j1, bufferedimage.getWidth(), bufferedimage.getHeight(), i >> j1, j >> j1));
            }

            aint[j1] = new int[bufferedimage.getWidth() * bufferedimage.getHeight()];
            bufferedimage.getRGB(0, 0, bufferedimage.getWidth(), bufferedimage.getHeight(), aint[j1], 0, bufferedimage.getWidth());
         }
      }
      ...
      if (meta == null) {
         ...
         if (meta.getFrameCount() > 0) {
            ...
            for(i1 = 0; i1 < j1; ++i1) {
               this.framesTextureData.add(getFrameTextureData(aint, k1, l, i1));
