...
public class ModelBlockDefinition {
   ...
   public ModelBlockDefinition(Collection p_i46221_1_) {
      ...
      while(var2.hasNext()) {
         Variants modelblockdefinition$variants = (Variants)var2.next();
   ...
   public static class Deserializer implements JsonDeserializer {
      ...
      protected Variants parseVariants(JsonDeserializationContext p_178335_1_, Map.Entry p_178335_2_) {
