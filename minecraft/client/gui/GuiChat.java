...
public class GuiChat extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      float inputWidth = input == null ? 0.0F : (float)this.mc.fontRendererObj.getStringWidth(input + "_");
      int maxWidth = true;
      int minWidth = true;
      float opacity = this.mc.gameSettings.chatOpacity;
      double boxWidth = (double)(Math.max(this.mc.gameSettings.chatWidth * 280.0F + 40.0F, inputWidth) + 6.0F);
      BlurUtil.blurArea(2.0, (double)(this.height - 14), boxWidth, 12.0);
      DrawUtil.glDrawFilledQuad(2.0, (double)(this.height - 14), boxWidth, 12.0, (int)(opacity * 255.0F) << 24);
