...
public class GuiPlayerTabOverlay extends Gui {
   private static final Ordering field_175252_a = Ordering.from(new PlayerComparator());
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      int j5;
      if (list1 != null) {
         DrawUtil.glDrawFilledRect((double)(width / 2 - l1 / 2 - 1), (double)(k1 - 1), (double)(width / 2 + l1 / 2 + 1), (double)(k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);
      ...
      DrawUtil.glDrawFilledRect((double)(width / 2 - l1 / 2 - 1), (double)(k1 - 1), (double)(width / 2 + l1 / 2 + 1), (double)(k1 + i4 * 9), Integer.MIN_VALUE);
      ...
      for(int k4 = 0; k4 < l3; ++k4) {
         ...
         int k2 = k1 + j5 * 9;
         DrawUtil.glDrawFilledRect((double)j2, (double)k2, (double)(j2 + i1), (double)(k2 + 8), 553648127);
         ...
         if (k4 < list.size()) {
            ...
            if (flag) {
               ...
               int l2 = 8 + (flag1 ? 8 : 0);
               int i3 = 8 * (flag1 ? -1 : 1);
               Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 8.0F, (float)l2, 8, i3, 8.0, 8.0, 64.0F, 64.0F);
               if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                  int j3 = 8 + (flag1 ? 8 : 0);
                  int k3 = 8 * (flag1 ? -1 : 1);
                  Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 40.0F, (float)j3, 8, k3, 8.0, 8.0, 64.0F, 64.0F);
               }
      ...
      if (list2 != null) {
         k1 = k1 + i4 * 9 + 1;
         DrawUtil.glDrawFilledRect((double)(width / 2 - l1 / 2 - 1), (double)(k1 - 1), (double)(width / 2 + l1 / 2 + 1), (double)(k1 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT), Integer.MIN_VALUE);
