      ...
      if (this.buttonsNotDrawn && i >= 0) {
         ...
         for(int l = 0; l <= 2; ++l) {
            ...
            for(l2 = 0; l2 < j2; ++l2) {
               ...
               guibeacon$powerbutton2 = new PowerButton(l << 8 | i3, this.guiLeft + 76 + l2 * 24 - k2 / 2, this.guiTop + 22 + l * 25, i3, l);
         ...
         for(l2 = 0; l2 < j2 - 1; ++l2) {
            ...
            guibeacon$powerbutton2 = new PowerButton(i2 << 8 | i3, this.guiLeft + 167 + l2 * 24 - k2 / 2, this.guiTop + 47, i3, i2);
            this.buttonList.add(guibeacon$powerbutton2);
            if (i2 >= i) {
               guibeacon$powerbutton2.enabled = false;
            } else if (i3 == k) {
