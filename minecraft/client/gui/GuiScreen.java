...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   protected void drawHoveringText(List textLines, int x, int y) {
      if (!textLines.isEmpty()) {
         ...
         int l = -267386864;
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 - 4), (double)(l1 + i + 3), (double)(i2 - 3), l, l);
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 + k + 3), (double)(l1 + i + 3), (double)(i2 + k + 4), l, l);
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 - 3), (double)(l1 + i + 3), (double)(i2 + k + 3), l, l);
         DrawUtil.glDrawFilledRect((double)(l1 - 4), (double)(i2 - 3), (double)(l1 - 3), (double)(i2 + k + 3), l, l);
         DrawUtil.glDrawFilledRect((double)(l1 + i + 3), (double)(i2 - 3), (double)(l1 + i + 4), (double)(i2 + k + 3), l, l);
         int i1 = 1347420415;
         int j1 = (i1 & 16711422) >> 1 | i1 & -16777216;
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 - 3 + 1), (double)(l1 - 3 + 1), (double)(i2 + k + 3 - 1), i1, j1);
         DrawUtil.glDrawFilledRect((double)(l1 + i + 2), (double)(i2 - 3 + 1), (double)(l1 + i + 3), (double)(i2 + k + 3 - 1), i1, j1);
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 - 3), (double)(l1 + i + 3), (double)(i2 - 3 + 1), i1, i1);
         DrawUtil.glDrawFilledRect((double)(l1 - 3), (double)(i2 + k + 2), (double)(l1 + i + 3), (double)(i2 + k + 3), j1, j1);
   ...
   public void drawWorldBackground(int tint) {
      if (this.mc.theWorld != null) {
         DrawUtil.glDrawFilledRect(0.0, 0.0, (double)this.width, (double)this.height, -1072689136, -804253680);
      } else {
   ...
   public void drawBackground(int tint) {
      ...
      worldrenderer.pos(0.0, (double)this.height, 0.0).tex(0.0, (double)((float)this.height / 32.0F + (float)tint)).color(64, 64, 64, 255).endVertex();
      worldrenderer.pos((double)this.width, (double)this.height, 0.0).tex((double)((float)this.width / 32.0F), (double)((float)this.height / 32.0F + (float)tint)).color(64, 64, 64, 255).endVertex();
      worldrenderer.pos((double)this.width, 0.0, 0.0).tex((double)((float)this.width / 32.0F), (double)tint).color(64, 64, 64, 255).endVertex();
