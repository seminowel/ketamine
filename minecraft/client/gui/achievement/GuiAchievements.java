   ...
   protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      if (achievement != null) {
         ...
         if (this.statFileWriter.canUnlockAchievement(achievement)) {
            ...
            DrawUtil.glDrawFilledRect((double)(l6 - 3), (double)(j7 - 3), (double)(l6 + l8 + 3), (double)(j7 + i9 + 3 + 12), -1073741824, -1073741824);
            ...
            if (l7 == 3) {
               ...
               DrawUtil.glDrawFilledRect((double)(l6 - 3), (double)(j7 - 3), (double)(l6 + l8 + 3), (double)(j7 + j9 + 12 + 3), -1073741824, -1073741824);
