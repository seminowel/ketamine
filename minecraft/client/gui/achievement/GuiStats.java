         ...
         if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
            ...
            if (i >= 0) {
               ...
               if (s.length() > 0) {
                  ...
                  DrawUtil.glDrawFilledRect((double)(k - 3), (double)(l - 3), (double)(k + i1 + 3), (double)(l + 8 + 3), -1073741824, -1073741824);
      ...
      protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
         if (p_148213_1_ != null) {
            ...
            if (s1.length() > 0) {
               ...
               DrawUtil.glDrawFilledRect((double)(i - 3), (double)(j - 3), (double)(i + k + 3), (double)(j + 8 + 3), -1073741824, -1073741824);
