      ...
      if (this.anvil.maximumCost > 0) {
         ...
         if (flag) {
            ...
            if (this.fontRendererObj.getUnicodeFlag()) {
               DrawUtil.glDrawFilledRect((double)(k - 3), (double)(l - 2), (double)(this.xSize - 7), (double)(l + 10), -16777216);
               DrawUtil.glDrawFilledRect((double)(k - 2), (double)(l - 1), (double)(this.xSize - 8), (double)(l + 9), -12895429);
            } else {
