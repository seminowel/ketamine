...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void onUpdatePlayer() {
      ...
      if (!riding) {
         SendSprintStateEvent sprintEvent = new SendSprintStateEvent(this.isSprinting());
         KetamineClient.getInstance().getEventBus().post(sprintEvent);
         boolean clientSprintState = sprintEvent.isSprintState();
      ...
      if (this.isCurrentViewEntity()) {
         UpdatePositionEvent updatePositionEvent = new UpdatePositionEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.lastReportedPosX, this.lastReportedPosY, this.lastReportedPosZ, this.rotationYaw, this.rotationPitch, this.lastReportedYaw, this.lastReportedPitch, this.onGround, this.lastEvent != null ? this.lastEvent.isOnGround() : this.mc.thePlayer.onGround);
