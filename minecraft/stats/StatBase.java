   ...
   static {
      ...
      timeStatType = new IStatType() {
         public String format(int p_75843_1_) {
            ...
            double d3 = d2 / 24.0;
            double d4 = d3 / 365.0;
            return d4 > 0.5 ? StatBase.decimalFormat.format(d4) + " y" : (d3 > 0.5 ? StatBase.decimalFormat.format(d3) + " d" : (d2 > 0.5 ? StatBase.decimalFormat.format(d2) + " h" : (d1 > 0.5 ? StatBase.decimalFormat.format(d1) + " m" : d0 + " s")));
         }
      };
      distanceStatType = new IStatType() {
         public String format(int p_75843_1_) {
            ...
            double d1 = d0 / 1000.0;
            return d1 > 0.5 ? StatBase.decimalFormat.format(d1) + " km" : (d0 > 0.5 ? StatBase.decimalFormat.format(d0) + " m" : p_75843_1_ + " cm");
         }
      };
      field_111202_k = new IStatType() {
         public String format(int p_75843_1_) {
            return StatBase.decimalFormat.format((double)p_75843_1_ * 0.1);
         }
      };
   }
}
