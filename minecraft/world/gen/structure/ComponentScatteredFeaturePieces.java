...
public class ComponentScatteredFeaturePieces {
   ...
   public static class DesertPyramid extends Feature {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         k = this.getMetadataWithOffset(Blocks.sandstone_stairs, 0);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(k), 0, 10, 2, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(k), this.scatteredFeatureSizeX - 5, 10, 2, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(k), this.scatteredFeatureSizeX - 3, 1, 2, structureBoundingBoxIn);
         ...
         while(var14.hasNext()) {
            EnumFacing enumfacing = (EnumFacing)var14.next();
