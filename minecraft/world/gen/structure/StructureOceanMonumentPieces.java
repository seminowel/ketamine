...
public class StructureOceanMonumentPieces {
   ...
   interface MonumentRoomFitHelper {
      boolean func_175969_a(RoomDefinition var1);

      Piece func_175968_a(EnumFacing var1, RoomDefinition var2, Random var3);
   }
   ...
   public static class MonumentBuilding extends Piece {
         ...
         while(true) {
            while(true) {
               ...
               do {
                  do {
                     if (!var7.hasNext()) {
                        ...
                        while(var17.hasNext()) {
                           Piece structureoceanmonumentpieces$piece = (Piece)var17.next();
                     ...
                     structureoceanmonumentpieces$roomdefinition = (RoomDefinition)var7.next();
               ...
               while(iterator.hasNext()) {
                  MonumentRoomFitHelper structureoceanmonumentpieces$monumentroomfithelper = (MonumentRoomFitHelper)iterator.next();
      ...
      private List func_175836_a(Random p_175836_1_) {
         ...
         for(k2 = 0; k2 < 5; ++k2) {
            for(j3 = 0; j3 < 4; ++j3) {
               ...
               astructureoceanmonumentpieces$roomdefinition[l4] = new RoomDefinition(l4);
            }
         }
         ...
         RoomDefinition[] var19 = astructureoceanmonumentpieces$roomdefinition;
         var8 = astructureoceanmonumentpieces$roomdefinition.length;

         for(var9 = 0; var9 < var8; ++var9) {
            RoomDefinition structureoceanmonumentpieces$roomdefinition4 = var19[var9];
         ...
         label93:
         while(var21.hasNext()) {
            RoomDefinition structureoceanmonumentpieces$roomdefinition3 = (RoomDefinition)var21.next();
            int j5 = 0;
            i1 = 0;
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         while(var11.hasNext()) {
            Piece structureoceanmonumentpieces$piece = (Piece)var11.next();
