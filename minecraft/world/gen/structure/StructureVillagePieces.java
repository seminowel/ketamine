...
public class StructureVillagePieces {
   ...
   private static Village func_176065_a(Start start, PieceWeight weight, List p_176065_2_, Random rand, int p_176065_4_, int p_176065_5_, int p_176065_6_, EnumFacing facing, int p_176065_8_) {
   ...
   private static Village func_176067_c(Start start, List p_176067_1_, Random rand, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing facing, int p_176067_7_) {
      ...
      if (i <= 0) {
         ...
         while(j < 5) {
            ...
            while(var11.hasNext()) {
               PieceWeight structurevillagepieces$pieceweight = (PieceWeight)var11.next();
   ...
   private static StructureComponent func_176066_d(Start start, List p_176066_1_, Random rand, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing facing, int p_176066_7_) {
      if (p_176066_7_ > 50) {
         return null;
   ...
   private static StructureComponent func_176069_e(Start start, List p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_) {
   ...
   public static class WoodHut extends Village {
      ...
      public static WoodHut func_175853_a(Start start, List p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_) {
   ...
   abstract static class Village extends StructureComponent {
      ...
      protected StructureComponent getNextComponentNN(Start start, List p_74891_2_, Random rand, int p_74891_4_, int p_74891_5_) {
      ...
      protected StructureComponent getNextComponentPP(Start start, List p_74894_2_, Random rand, int p_74894_4_, int p_74894_5_) {
         if (this.coordBaseMode != null) {
            switch (this.coordBaseMode) {
               case NORTH:
   ...
   public static class Torch extends Village {
      ...
      public static StructureBoundingBox func_175856_a(Start start, List p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing) {
   ...
   public static class Path extends Road {
      ...
      public void buildComponent(StructureComponent componentIn, List listIn, Random rand) {
         ...
         for(j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
            structurecomponent1 = this.getNextComponentNN((Start)componentIn, listIn, rand, 0, j);
         ...
         for(j = rand.nextInt(5); j < this.length - 8; j += 2 + rand.nextInt(5)) {
            structurecomponent1 = this.getNextComponentPP((Start)componentIn, listIn, rand, 0, j);
            if (structurecomponent1 != null) {
               j += Math.max(structurecomponent1.boundingBox.getXSize(), structurecomponent1.boundingBox.getZSize());
               flag = true;
            }
      ...
      public static StructureBoundingBox func_175848_a(Start start, List p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing) {
   ...
   public static class House4Garden extends Village {
      ...
      public static House4Garden func_175858_a(Start start, List p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_) {
   ...
   public static class House3 extends Village {
      ...
      public static House3 func_175849_a(Start start, List p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_) {
   ...
   public static class House2 extends Village {
      ...
      public static House2 func_175855_a(Start start, List p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_) {
   ...
   public static class House1 extends Village {
      ...
      public static House1 func_175850_a(Start start, List p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_) {
   ...
   public static class Hall extends Village {
      ...
      public static Hall func_175857_a(Start start, List p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_) {
   ...
   public static class Field2 extends Village {
      ...
      public static Field2 func_175852_a(Start start, List p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_) {
   ...
   public static class Field1 extends Village {
      ...
      public static Field1 func_175851_a(Start start, List p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_) {
   ...
   public static class Church extends Village {
      ...
      public static Church func_175854_a(Start start, List p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_) {
