...
public class StructureNetherBridgePieces {
   ...
   private static Piece func_175887_b(PieceWeight p_175887_0_, List p_175887_1_, Random p_175887_2_, int p_175887_3_, int p_175887_4_, int p_175887_5_, EnumFacing p_175887_6_, int p_175887_7_) {
      ...
      return (Piece)structurenetherbridgepieces$piece;
   }
   ...
   public static class Start extends Crossing3 {
      ...
      public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_) {
         ...
         int var6;
         PieceWeight structurenetherbridgepieces$pieceweight1;
   ...
   abstract static class Piece extends StructureComponent {
      ...
      private int getTotalWeight(List p_74960_1_) {
         ...
         PieceWeight structurenetherbridgepieces$pieceweight;
         for(Iterator var4 = p_74960_1_.iterator(); var4.hasNext(); i += structurenetherbridgepieces$pieceweight.field_78826_b) {
            structurenetherbridgepieces$pieceweight = (PieceWeight)var4.next();
      ...
      private Piece func_175871_a(Start p_175871_1_, List p_175871_2_, List p_175871_3_, Random p_175871_4_, int p_175871_5_, int p_175871_6_, int p_175871_7_, EnumFacing p_175871_8_, int p_175871_9_) {
         ...
         while(j < 5 && flag) {
            ...
            while(var14.hasNext()) {
               PieceWeight structurenetherbridgepieces$pieceweight = (PieceWeight)var14.next();
