      ...
      if (k >= 1 && k + i + 1 < 256) {
         ...
         if (block != Blocks.grass && block != Blocks.dirt) {
            ...
            for(k3 = -2; k3 <= 0; ++k3) {
               for(j4 = -2; j4 <= 0; ++j4) {
                  l4 = -1;
                  this.func_150526_a(worldIn, k1 + k3, i2 + l4, l1 + j4);
                  this.func_150526_a(worldIn, 1 + k1 - k3, i2 + l4, l1 + j4);
                  this.func_150526_a(worldIn, k1 + k3, i2 + l4, 1 + l1 - j4);
                  this.func_150526_a(worldIn, 1 + k1 - k3, i2 + l4, 1 + l1 - j4);
