      ...
      if (this.worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
         ...
         while(true) {
            ...
            do {
               ...
               k = chunkcoordintpair.chunkXPos * 16;
               l = chunkcoordintpair.chunkZPos * 16;
               chunk = this.getChunkFromChunkCoords(chunkcoordintpair.chunkXPos, chunkcoordintpair.chunkZPos);
      ...
      while(!this.field_147490_S[this.blockEventCacheIndex].isEmpty()) {
         ...
         while(var2.hasNext()) {
            ...
            if (this.fireBlockEvent(blockeventdata)) {
               this.mcServer.getConfigurationManager().sendToAllNear((double)blockeventdata.getPosition().getX(), (double)blockeventdata.getPosition().getY(), (double)blockeventdata.getPosition().getZ(), 64.0, this.provider.getDimensionId(), new S24PacketBlockAction(blockeventdata.getPosition(), blockeventdata.getBlock(), blockeventdata.getEventID(), blockeventdata.getEventParameter()));
            }
         }
