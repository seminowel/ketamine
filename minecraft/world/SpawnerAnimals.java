         ...
         while(true) {
            ...
            do {
               if (!var6.hasNext()) {
                  ...
                  label124:
                  for(l = 0; l < k; ++l) {
                     EnumCreatureType enumcreaturetype = var38[l];
                     if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs) && (enumcreaturetype.getPeacefulCreature() || spawnHostileMobs) && (!enumcreaturetype.getAnimal() || p_77192_4_)) {
                        ...
                        if (j1 <= k4) {
                           Iterator var41 = this.eligibleChunksForSpawning.iterator();
                           ...
                           while(true) {
                              ...
                              do {
                                 ...
                                 ChunkCoordIntPair chunkcoordintpair1 = (ChunkCoordIntPair)var41.next();
                              ...
                              for(int k2 = 0; k2 < 3; ++k2) {
                                 ...
                                 for(int l3 = 0; l3 < 4; ++l3) {
                                    ...
                                    if (!p_77192_1_.isAnyPlayerWithinRangeAt((double)f, (double)i3, (double)f1, 24.0) && blockpos2.distanceSq((double)f, (double)i3, (double)f1) >= 576.0) {
            ...
            k = MathHelper.floor_double(entityplayer.posZ / 16.0);
            l = 8;
