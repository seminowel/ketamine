...
public class Teleporter {
   ...
   public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
      ...
      if (d0 >= 0.0) {
         if (flag) {
            this.destinationCoordinateCache.add(l, new PortalPosition((BlockPos)blockpos, this.worldServerInstance.getTotalWorldTime()));
            this.destinationCoordinateKeys.add(l);
         }

         double d5 = (double)((BlockPos)blockpos).getX() + 0.5;
         double d6 = (double)((BlockPos)blockpos).getY() + 0.5;
         double d7 = (double)((BlockPos)blockpos).getZ() + 0.5;
   ...
   public boolean makePortal(Entity p_85188_1_) {
      ...
      for(l5 = j - i; l5 <= j + i; ++l5) {
         d3 = (double)l5 + 0.5 - p_85188_1_.posX;

         for(j6 = l - i; j6 <= l + i; ++j6) {
            d4 = (double)j6 + 0.5 - p_85188_1_.posZ;
            ...
            for(i7 = this.worldServerInstance.getActualHeight() - 1; i7 >= 0; --i7) {
               if (this.worldServerInstance.isAirBlock(blockpos$mutableblockpos.func_181079_c(l5, i7, j6))) {
                  ...
                  for(k7 = i2; k7 < i2 + 4; ++k7) {
                     ...
                     d6 = (double)i7 + 0.5 - p_85188_1_.posY;
      ...
      if (worldTime % 100L == 0L) {
         ...
         while(true) {
            ...
            do {
               ...
               teleporter$portalposition = (PortalPosition)this.destinationCoordinateCache.getValueByKey(olong);
