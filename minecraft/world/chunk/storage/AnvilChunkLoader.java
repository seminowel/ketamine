...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private Chunk readChunkFromNBT(World worldIn, NBTTagCompound p_75823_2_) {
      ...
      for(int l = 0; l < nbttaglist.tagCount(); ++l) {
         ...
         l2 = nbttagcompound.getByte("Y");
         ExtendedBlockStorage extendedblockstorage = new ExtendedBlockStorage(l2 << 4, flag);
         ...
         aextendedblockstorage[l2] = extendedblockstorage;
      }
      ...
      if (nbttaglist2 != null) {
         for(l2 = 0; l2 < nbttaglist2.tagCount(); ++l2) {
