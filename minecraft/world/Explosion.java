...
public class Explosion {
   ...
   public void doExplosionA() {
      ...
      k = MathHelper.floor_double(this.explosionX - (double)f3 - 1.0);
      l = MathHelper.floor_double(this.explosionX + (double)f3 + 1.0);
      ...
      if (this.isSmoking) {
         ...
         while(var2.hasNext()) {
            ...
            if (spawnParticles) {
               ...
               d4 *= d7;
               d5 *= d7;
               this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL, (d0 + this.explosionX * 1.0) / 2.0, (d1 + this.explosionY * 1.0) / 2.0, (d2 + this.explosionZ * 1.0) / 2.0, d3, d4, d5);
