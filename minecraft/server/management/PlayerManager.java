   ...
   public void updatePlayerInstances() {
      ...
      if (i - this.previousTotalWorldTime > 8000L) {
         ...
         for(j = 0; j < this.playerInstanceList.size(); ++j) {
            playermanager$playerinstance = (PlayerInstance)this.playerInstanceList.get(j);
         ...
         for(j = 0; j < this.playerInstancesToUpdate.size(); ++j) {
            playermanager$playerinstance = (PlayerInstance)this.playerInstancesToUpdate.get(j);
            playermanager$playerinstance.onUpdate();
         }
      }
