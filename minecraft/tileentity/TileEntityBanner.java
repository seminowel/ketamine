         ...
         if (!this.field_175119_g) {
            ...
            if (this.patterns != null) {
               for(int i = 0; i < this.patterns.tagCount(); ++i) {
                  ...
                  EnumBannerPattern tileentitybanner$enumbannerpattern = TileEntityBanner.EnumBannerPattern.getPatternByID(nbttagcompound.getString("Pattern"));
   ...
   public static enum EnumBannerPattern {
      ...
      public static EnumBannerPattern getPatternByID(String id) {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            EnumBannerPattern tileentitybanner$enumbannerpattern = var1[var3];
