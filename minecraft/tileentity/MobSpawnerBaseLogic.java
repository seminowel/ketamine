   ...
   public void updateSpawner() {
      if (this.isActivated()) {
         ...
         if (this.getSpawnerWorld().isRemote) {
            ...
            this.getSpawnerWorld().spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d3, d4, d0, 0.0, 0.0, 0.0);
            this.getSpawnerWorld().spawnParticle(EnumParticleTypes.FLAME, d3, d4, d0, 0.0, 0.0, 0.0);
            ...
            while(true) {
               ...
               d0 = (double)blockpos.getX() + (this.getSpawnerWorld().rand.nextDouble() - this.getSpawnerWorld().rand.nextDouble()) * (double)this.spawnRange + 0.5;
      ...
      if (!StringUtils.isNullOrEmpty(s)) {
         ...
         if (this.getRandomEntity() != null || this.minecartToSpawn.size() > 0) {
            ...
            if (this.minecartToSpawn.size() > 0) {
               ...
               while(var4.hasNext()) {
                  WeightedRandomMinecart mobspawnerbaselogic$weightedrandomminecart = (WeightedRandomMinecart)var4.next();
