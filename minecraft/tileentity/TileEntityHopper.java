...
public class TileEntityHopper extends TileEntityLockable implements IHopper, ITickable {
   ...
   public static boolean captureDroppedItems(IHopper p_145891_0_) {
      ...
      if (iinventory != null) {
         ...
         Iterator var6 = func_181556_a(p_145891_0_.getWorld(), p_145891_0_.getXPos(), p_145891_0_.getYPos() + 1.0, p_145891_0_.getZPos()).iterator();
   ...
   public static IInventory getInventoryAtPosition(World worldIn, double x, double y, double z) {
      ...
      if (iinventory == null) {
         List list = worldIn.getEntitiesInAABBexcluding((Entity)null, new AxisAlignedBB(x - 0.5, y - 0.5, z - 0.5, x + 0.5, y + 0.5, z + 0.5), EntitySelectors.selectInventories);
         if (list.size() > 0) {
