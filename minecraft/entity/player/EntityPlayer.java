...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void onLivingUpdate() {
      ...
      float f1 = (float)(Math.atan(-this.motionY * 0.20000000298023224) * 15.0);
      if (f > 0.1F) {
         f = 0.1F;
      }
      ...
      if (this.ridingEntity != null) {
         ...
         if (i > 0) {
            if (this.ridingEntity instanceof EntityMinecart) {
               ...
               } else if (this.startMinecartRidingCoordinate.distanceSq((double)MathHelper.floor_double(this.posX), (double)MathHelper.floor_double(this.posY), (double)MathHelper.floor_double(this.posZ)) >= 1000000.0) {
   ...
   public static enum EnumChatVisibility {
      ...
      static {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            EnumChatVisibility entityplayer$enumchatvisibility = var0[var2];
