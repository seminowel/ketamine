...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      if (this.noClip) {
         ...
         double d4 = y;
         double d5 = z;
         SafeWalkEvent shouldSafeWalkEvent = new SafeWalkEvent();
         ...
         Iterator var57;
         for(var57 = list1.iterator(); var57.hasNext(); x = axisalignedbb13.calculateXOffset(this.getEntityBoundingBox(), x)) {
            axisalignedbb13 = (AxisAlignedBB)var57.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0.0, 0.0));

         for(var57 = list1.iterator(); var57.hasNext(); z = axisalignedbb13.calculateZOffset(this.getEntityBoundingBox(), z)) {
            axisalignedbb13 = (AxisAlignedBB)var57.next();
         }
         ...
         if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            ...
            for(Iterator var41 = list.iterator(); var41.hasNext(); d16 = axisalignedbb8.calculateZOffset(axisalignedbb4, d16)) {
            ...
            this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0, y, 0.0));
            if (this instanceof EntityPlayerSP) {
               double blockHeight = (double)event.getStepHeight() + y;
         ...
         try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport(var54, "Checking entity block collision");
   ...
   public void moveFlying(float strafe, float forward, float friction) {
      MoveFlyingInputEvent inputEvent = new MoveFlyingInputEvent(forward, strafe, friction, this.rotationYaw);
      if (this instanceof EntityPlayerSP) {
   ...
   public void func_181015_d(BlockPos p_181015_1_) {
      if (this.timeUntilPortal > 0) {
         ...
         if (!this.worldObj.isRemote && !p_181015_1_.equals(this.field_181016_an)) {
            ...
            double d2 = MathHelper.func_181160_c(this.posY - 1.0, (double)blockpattern$patternhelper.func_181117_a().getY(), (double)(blockpattern$patternhelper.func_181117_a().getY() - blockpattern$patternhelper.func_181119_e()));
