...
public abstract class EntityThrowable extends Entity implements IProjectile {
   ...
   public void onUpdate() {
      ...
      for(this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, (double)f1) * 180.0 / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
      }
