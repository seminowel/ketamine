...
public class EntityFishHook extends Entity {
   ...
   public void onUpdate() {
      ...
      if (this.fishPosRotationIncrements > 0) {
         ...
         Entity entity = null;
         List list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().addCoord(this.motionX, this.motionY, this.motionZ).expand(1.0, 1.0, 1.0));
         double d0 = 0.0;
         ...
         if (!this.inGround) {
            ...
            for(this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, (double)f5) * 180.0 / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
            }
               ...
               if (this.ticksCatchable > 0) {
                  ...
                  if (this.ticksCatchableDelay > 0) {
                     ...
                     if (this.ticksCatchableDelay <= 0) {
                        ...
                        worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX, (double)(f1 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0, (double)this.width, 0.20000000298023224);
                        worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, this.posX, (double)(f1 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0, (double)this.width, 0.20000000298023224);
                        ...
                        if (block == Blocks.water || block == Blocks.flowing_water) {
                           if (this.rand.nextFloat() < 0.15F) {
                              worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d12, d14 - 0.10000000149011612, d6, 1, (double)f9, 0.1, (double)f2, 0.0);
                           }

                           float f3 = f9 * 0.04F;
                           float f4 = f2 * 0.04F;
                           worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d12, d14, d6, 0, (double)f4, 0.01, (double)(-f3), 1.0);
                           worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d12, d14, d6, 0, (double)(-f4), 0.01, (double)f3, 1.0);
                        }
                     }
                     ...
                     if (this.rand.nextFloat() < f1) {
                        ...
                        block = worldserver.getBlockState(new BlockPos((int)d12, (int)d14 - 1, (int)d6)).getBlock();
                        if (block == Blocks.water || block == Blocks.flowing_water) {
                           worldserver.spawnParticle(EnumParticleTypes.WATER_SPLASH, d12, d14, d6, 2 + this.rand.nextInt(2), 0.10000000149011612, 0.0, 0.10000000149011612, 0.0);
                        }
                     }
   ...
   public int handleHookRetraction() {
      if (this.worldObj.isRemote) {
         ...
         if (this.caughtEntity != null) {
            ...
            var10000.motionY += d2 * d8 + (double)MathHelper.sqrt_double(d6) * 0.08;
            var10000 = this.caughtEntity;
