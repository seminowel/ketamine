      ...
      if (this.inGround) {
         ...
         if (movingobjectposition != null) {
            if (movingobjectposition.entityHit != null) {
               ...
               this.posX -= this.motionX / (double)f6 * 0.05000000074505806;
               this.posY -= this.motionY / (double)f6 * 0.05000000074505806;
               this.posZ -= this.motionZ / (double)f6 * 0.05000000074505806;
               this.playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
               this.inGround = true;
               this.arrowShake = 7;
         ...
         if (this.getIsCritical()) {
            for(k = 0; k < 4; ++k) {
               this.worldObj.spawnParticle(EnumParticleTypes.CRIT, this.posX + this.motionX * (double)k / 4.0, this.posY + this.motionY * (double)k / 4.0, this.posZ + this.motionZ * (double)k / 4.0, -this.motionX, -this.motionY + 0.2, -this.motionZ);
            }
         }
         ...
         for(this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, (double)f3) * 180.0 / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
         }
