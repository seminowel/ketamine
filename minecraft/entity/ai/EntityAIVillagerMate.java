   ...
   public boolean shouldExecute() {
      if (this.villagerObj.getGrowingAge() != 0) {
         ...
         if (this.villageObj == null) {
            ...
            Entity entity = this.worldObj.findNearestEntityWithinAABB(EntityVillager.class, this.villagerObj.getEntityBoundingBox().expand(8.0, 3.0, 8.0), this.villagerObj);
            if (entity == null) {
               return false;
            } else {
