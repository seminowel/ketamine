...
public class EntityHorse extends EntityAnimal implements IInvBasic {
   ...
   protected void spawnHorseParticles(boolean p_110216_1_) {
      ...
      for(int i = 0; i < 7; ++i) {
         ...
         this.worldObj.spawnParticle(enumparticletypes, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 0.5 + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
      }
