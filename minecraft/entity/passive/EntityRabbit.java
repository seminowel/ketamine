...
public class EntityRabbit extends EntityAnimal {
   ...
   static class AIRaidFarm extends EntityAIMoveToBlock {
      ...
      public void updateTask() {
         super.updateTask();
         this.field_179500_c.getLookHelper().setLookPosition((double)this.destinationBlock.getX() + 0.5, (double)(this.destinationBlock.getY() + 1), (double)this.destinationBlock.getZ() + 0.5, 10.0F, (float)this.field_179500_c.getVerticalFaceSpeed());
