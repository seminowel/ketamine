...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc {
   ...
   private void populateBuyingList() {
      ...
      if (j >= 0 && j < aentityvillager$itradelist1.length) {
         ...
         ITradeList[] var6 = aentityvillager$itradelist2;
         int var7 = aentityvillager$itradelist2.length;

         for(int var8 = 0; var8 < var7; ++var8) {
            ITradeList entityvillager$itradelist = var6[var8];
   ...
   private void spawnParticles(EnumParticleTypes particleType) {
      for(int i = 0; i < 5; ++i) {
         ...
         this.worldObj.spawnParticle(particleType, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 1.0 + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, d0, d1, d2);
      }
