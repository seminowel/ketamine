...
public abstract class EntityMob extends EntityCreature implements IMob {
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
      ...
      if (flag) {
         if (i > 0) {
            entityIn.addVelocity((double)(-MathHelper.sin(this.rotationYaw * 3.1415927F / 180.0F) * (float)i * 0.5F), 0.1, (double)(MathHelper.cos(this.rotationYaw * 3.1415927F / 180.0F) * (float)i * 0.5F));
            this.motionX *= 0.6;
            this.motionZ *= 0.6;
         }
