...
public class EntityBoat extends Entity {
   ...
   public void onUpdate() {
      ...
      int i2;
      if (d9 > 0.2975) {
         d11 = Math.cos((double)this.rotationYaw * Math.PI / 180.0);
         d15 = Math.sin((double)this.rotationYaw * Math.PI / 180.0);

         for(i2 = 0; (double)i2 < 1.0 + d9 * 60.0; ++i2) {
            double d5 = (double)(this.rand.nextFloat() * 2.0F - 1.0F);
            double d6 = (double)(this.rand.nextInt(2) * 2 - 1) * 0.7;
            double d7;
            double d8;
            if (this.rand.nextBoolean()) {
               d7 = this.posX - d11 * d5 * 0.8 + d15 * d6;
               d8 = this.posZ - d15 * d5 * 0.8 - d11 * d6;
               this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, d7, this.posY - 0.125, d8, this.motionX, this.motionY, this.motionZ);
            } else {
               d7 = this.posX + d11 + d15 * d5 * 0.7;
               d8 = this.posZ + d15 - d11 * d5 * 0.7;
               this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, d7, this.posY - 0.125, d8, this.motionX, this.motionY, this.motionZ);
            }
         }
      }
      ...
      if (this.worldObj.isRemote && this.isBoatEmpty) {
         ...
         for(k1 = 0; k1 < 4; ++k1) {
            ...
            i2 = MathHelper.floor_double(this.posZ + ((double)(k1 / 2) - 0.5) * 0.8);
         ...
         if (!this.worldObj.isRemote) {
            List list = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224));
