...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
   ...
   public void onLivingUpdate() {
      ...
      for(i1 = 0; i1 < 3; ++i1) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d10 + this.rand.nextGaussian() * 0.30000001192092896, d2 + this.rand.nextGaussian() * 0.30000001192092896, d4 + this.rand.nextGaussian() * 0.30000001192092896, 0.0, 0.0, 0.0);
         if (flag && this.worldObj.rand.nextInt(4) == 0) {
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, d10 + this.rand.nextGaussian() * 0.30000001192092896, d2 + this.rand.nextGaussian() * 0.30000001192092896, d4 + this.rand.nextGaussian() * 0.30000001192092896, 0.699999988079071, 0.699999988079071, 0.5);
         }
      }

      if (this.getInvulTime() > 0) {
         for(i1 = 0; i1 < 3; ++i1) {
            this.worldObj.spawnParticle(EnumParticleTypes.SPELL_MOB, this.posX + this.rand.nextGaussian() * 1.0, this.posY + (double)(this.rand.nextFloat() * 3.3F), this.posZ + this.rand.nextGaussian() * 1.0, 0.699999988079071, 0.699999988079071, 0.8999999761581421);
         }
      }
         ...
         for(i = 1; i < 3; ++i) {
            if (this.ticksExisted >= this.field_82223_h[i - 1]) {
               ...
               if (l1 > 0) {
                  ...
                  List list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0, 8.0, 20.0), Predicates.and(attackEntitySelector, EntitySelectors.NOT_SPECTATING));
   ...
   protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
      ...
      if (!this.worldObj.isRemote) {
         Iterator var4 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, this.getEntityBoundingBox().expand(50.0, 100.0, 50.0)).iterator();
