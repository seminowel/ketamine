...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
   ...
   public void onLivingUpdate() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX + (double)f10, this.posY + 2.0 + (double)f12, this.posZ + (double)f2, 0.0, 0.0, 0.0);
      } else {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.worldObj.isRemote) {
               ...
               if (this.target != null) {
                  ...
                  d15 = 0.4000000059604645 + d7 / 80.0 - 1.0;
                  if (d15 > 10.0) {
                     d15 = 10.0;
                  }
            ...
            this.dragonPartHead.setLocationAndAngles(this.posX + (double)(f17 * 5.5F * f2), this.posY + (adouble[1] - adouble1[1]) * 1.0 + (double)(f15 * 5.5F), this.posZ - (double)(f19 * 5.5F * f2), 0.0F, 0.0F);
            ...
            for(int j = 0; j < 3; ++j) {
               ...
               entitydragonpart.setLocationAndAngles(this.posX - (double)((f16 * f23 + f21 * f5) * f2), this.posY + (adouble2[1] - adouble1[1]) * 1.0 - (double)((f5 + f23) * f15) + 1.5, this.posZ + (double)((f4 * f23 + f22 * f5) * f2), 0.0F, 0.0F);
            }
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTicks >= 180 && this.deathTicks <= 200) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.posX + (double)f, this.posY + 2.0 + (double)f1, this.posZ + (double)f2, 0.0, 0.0, 0.0);
      }
