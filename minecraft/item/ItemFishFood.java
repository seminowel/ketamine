...
public class ItemFishFood extends ItemFood {
   ...
   public int getHealAmount(ItemStack stack) {
      FishType itemfishfood$fishtype = ItemFishFood.FishType.byItemStack(stack);
   ...
   public void getSubItems(Item itemIn, CreativeTabs tab, List subItems) {
      FishType[] var4 = ItemFishFood.FishType.values();
      int var5 = var4.length;

      for(int var6 = 0; var6 < var5; ++var6) {
         FishType itemfishfood$fishtype = var4[var6];
   ...
   public static enum FishType {
      ...
      public static FishType byMetadata(int meta) {
         FishType itemfishfood$fishtype = (FishType)META_LOOKUP.get(meta);
      ...
      static {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            FishType itemfishfood$fishtype = var0[var2];
