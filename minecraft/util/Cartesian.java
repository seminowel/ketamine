...
public class Cartesian {
   public static Iterable cartesianProduct(Class clazz, Iterable sets) {
      return new Product(clazz, (Iterable[])((Iterable[])toArray(Iterable.class, sets)));
   }
   ...
   static class Product implements Iterable {
      ...
      public Iterator iterator() {
         return (Iterator)(this.iterables.length <= 0 ? Collections.singletonList((Object[])Cartesian.createArray(this.clazz, 0)).iterator() : new ProductIterator(this.clazz, this.iterables));
      }
