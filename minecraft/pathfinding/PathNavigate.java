...
public abstract class PathNavigate {
   ...
   public PathEntity getPathToEntityLiving(Entity entityIn) {
      if (!this.canNavigate()) {
         ...
         int i = (int)(f + 16.0F);
         ChunkCache chunkcache = new ChunkCache(this.worldObj, blockpos.add(-i, -i, -i), blockpos.add(i, i, i), 0);
         return this.pathFinder.createEntityPathTo(chunkcache, this.theEntity, (Entity)entityIn, f);
      }
   }
      ...
      if (!this.noPath()) {
         ...
         if (!this.noPath()) {
            ...
            if (vec32 != null) {
               ...
               List list = this.worldObj.getCollidingBoundingBoxes(this.theEntity, axisalignedbb1.addCoord(0.0, -1.0, 0.0));
               double d0 = -1.0;
