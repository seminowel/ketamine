   ...
   protected void onCrafting(ItemStack stack) {
      ...
      if (!this.thePlayer.worldObj.isRemote) {
         ...
         while(i > 0) {
            ...
            i -= j;
            this.thePlayer.worldObj.spawnEntityInWorld(new EntityXPOrb(this.thePlayer.worldObj, this.thePlayer.posX, this.thePlayer.posY + 0.5, this.thePlayer.posZ + 0.5, j));
         }
      }
