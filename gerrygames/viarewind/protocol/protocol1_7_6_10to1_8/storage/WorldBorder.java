...
public class WorldBorder extends StoredObject implements Tickable {
   ...
   private void sendPackets() {
      ...
      Side[] var4 = WorldBorder.Side.values();
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         if (!(d >= 16.0)) {
            ...
            double b = 2.5;
            PacketWrapper particles = PacketWrapper.create(42, (ByteBuf)null, this.getUser());
            particles.write(Type.STRING, "fireworksSpark");
            particles.write(Type.FLOAT, (float)(side.modX != 0 ? this.x + radius * (double)side.modX : centerH));
            particles.write(Type.FLOAT, (float)centerV);
            particles.write(Type.FLOAT, (float)(side.modX == 0 ? this.z + radius * (double)side.modZ : centerH));
