...
public class Windows extends StoredObject {
   public HashMap types = new HashMap();
   public HashMap furnace = new HashMap();
   ...
   public static class Furnace {
      ...
      public boolean equals(Object o) {
         if (o == this) {
            return true;
         } else if (!(o instanceof Furnace)) {
            return false;
         } else {
            Furnace other = (Furnace)o;
            if (!other.canEqual(this)) {
               return false;
            } else if (this.getFuelLeft() != other.getFuelLeft()) {
               return false;
            } else if (this.getMaxFuel() != other.getMaxFuel()) {
               return false;
