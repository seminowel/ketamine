   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         if (!other.canEqual(this)) {
            return false;
         } else if (this.isSprinting() != other.isSprinting()) {
            return false;
         } else if (this.isAllowFly() != other.isAllowFly()) {
            return false;
         } else if (this.isFlying() != other.isFlying()) {
            return false;
         } else if (this.isInvincible() != other.isInvincible()) {
            return false;
         } else if (this.isCreative() != other.isCreative()) {
            return false;
